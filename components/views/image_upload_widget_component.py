...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_title = Text(
            page, f'{identifier}-image-upload-widget-info-title-text', "Image upload widget info title")

        self.image_upload_info_description = Text(
            page, f'{identifier}-image-upload-widget-info-description-text',
            "Image upload widget info description")
        ...
        self.upload_input = FileInput(page, f'{identifier}-image-upload-widget-input', "Upload files")
